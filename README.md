...
- [oomph-catalog](#oomph-catalog)
    ...
    - [Example status](#example-status)
        - [C:\Users\Reichert\.p2](#cusersreichertp2)
            - [pools.info](#poolsinfo)
            - [profiles.info](#profilesinfo)
        - [C:\_oomph_agent](#coomphagent)
            - [pools.info](#poolsinfo)
            - [profiles.info](#profilesinfo)
        - [C:\Users\Reichert\.eclipse\org.eclipse.oomph.p2](#cusersreicherteclipseorgeclipseoomphp2)
            - [agents.info](#agentsinfo)
            - [defaults.info](#defaultsinfo)
        - [C:\Users\Reichert\.eclipse\org.eclipse.oomph.p2\setups](#cusersreicherteclipseorgeclipseoomphp2setups)
...
Custom product and project catalogue for BizX development projects, inspired by [Alex' oomph setups](https://github.com/nittka/oomph-playground).

## Setup

### Linux 

* Run `devchef EclipseInstaller`

* Click on Eclipse Installer icon to start the installer

### Windows (not tested, yet)
 
 * download the [Oomph installer](http://wiki.eclipse.org/Eclipse_Oomph_Installer) 
 
 * For Windows download the [SAP JVM8](http://sapjvm.wdf.sap.corp:1080/downloads)
 
 * Run the downloaded Oomph Installer and point to the installation directory of SAP JVM8
 
 * Switch to advanced mode and choose an installation directory of your choice

 * add the following line to the installer's oomph.ini

`-Doomph.redirection.setups=index:/->http://dewdfgld03571.wdf.sap.corp:1080/bizx-oomph-catalog/setups/`
...
## Example walkthrough
   ...
   * Bundle Pool (Check): /data/oomph_bundle_pool
     * Manage Bundle Pools...
	   * Setup
